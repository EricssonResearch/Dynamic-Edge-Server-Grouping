...
import core.OutputTaskGraphXMLGenerator;
import core.TaskXMLGenerator;
...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        // Generate output
        TaskXMLGenerator xmlGeneratorInstance = TaskXMLGenerator.getInstance();
        xmlGeneratorInstance.generateTaskXMLFile(outputFolder);

        OutputTaskGraphXMLGenerator taskGraphInstance = OutputTaskGraphXMLGenerator.getInstance();
        taskGraphInstance.generateOutputTaskGraphXML(outputFolder);
    }
}